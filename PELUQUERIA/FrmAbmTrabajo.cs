...
{
    public partial class FrmAbmTrabajo : Form
    {
        public FrmAbmTrabajo()
        {
            InitializeComponent();
        }

        private void FrmAbmTrabajo_Load(object sender, EventArgs e)
        {
            Botonera(1);
            Grupo.Enabled = false;
        }
        ...
        private void btnAceptar_Click(object sender, EventArgs e)
        {
            ...
            Clases.cFunciones fun = new Clases.cFunciones();
            if (txtCodigo.Text == "")
                fun.GuardarNuevoGenerico(this, "Trabajo");
            else
                fun.ModificarGenerico(this, "Trabajo", "CodTrabajo", txtCodigo.Text);
        ...
        private void btnAbrir_Click(object sender, EventArgs e)
        {
            ...
            //nombre de la tabla, 
            Principal.TablaPrincipal = "Trabajo";

            Principal.OpcionesColumnasGrilla = "CodTrabajo; Nombre";
        ...
        private void form_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            if (Principal.CodigoPrincipalAbm != null)
            {
                if (Principal.CodigoPrincipalAbm != "")
                {
                    ...
                    if (Principal.CodigoPrincipalAbm != "")
                        fun.CargarControles(this, "Trabajo", "CodTrabajo", txtCodigo.Text);
                    Grupo.Enabled = false;
                    return;
                }
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            ...
            {
                Clases.cFunciones fun = new Clases.cFunciones();
                fun.EliminarGenerico("Trabajo", "CodTrabajo", txtCodigo.Text);
