...
namespace PELUQUERIA
{
    public partial class FrmBuscadorGenerico : Form
    {
        ...
        private void btnAceptar_Click(object sender, EventArgs e)
        {
            ...
            {  
                case "Trabajo":
                    FrmAbmTrabajo frm = new FrmAbmTrabajo();
                    frm.Focus();
                    break;
                case "Corte":
                ...
                case "Cliente":
                    ...
                    {
                        FrmAbmCliente cli = new FrmAbmCliente();
                        cli.Focus();
                    }

                    if (Principal.CodigoSenia == "2")
                    {
        ...
        private void FrmBuscadorGenerico_FormClosed(object sender, FormClosedEventArgs e)
        {
